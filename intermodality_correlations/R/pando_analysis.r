...
# data_path <- paste0(machine_path, "/work/FAC/FBM/LLB/dgfeller/scrnaseq/agabrie4/supercellV2/SuperCellMultiomicsAnalyses/output/", dataset, "/")
# opt <- list()
# opt$mcSeurat <- paste0(data_path, "SuperCellMulti/g20/seurat.multiome.activities.rds") # seurat.multiome.mc.activities.rds
# opt$singleCellSeurat <- paste0(data_path, "singlecells_analysis/seurat.multiome.activities.rds") #seurat.multiome.mc.activities.rds
# opt$mc.method <- "weights"
# opt$ncores <- 8
# opt$membership <- paste0(data_path, "/SuperCellMulti/g20/SuperCellMemberships.csv")
