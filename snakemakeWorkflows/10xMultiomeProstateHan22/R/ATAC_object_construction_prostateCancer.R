...
atac.prostate.merge<-merge(integarted.atac.WT.1.renames,y=c(integarted.atac.WT.2.renames,integarted.atac.2W.1.renames,integarted.atac.2W.2.renames,
                                                                  integarted.atac.1M.1.renames,integarted.atac.1M.2.renames,integarted.atac.2.5M.1.renames,
                                                                  integarted.atac.2.5M.2.renames,integarted.atac.2.5M.3.renames,integarted.atac.2.5M.4.renames,
                                                                  integarted.atac.3.5M.1.renames,integarted.atac.3.5M.2.renames,integarted.atac.4.5M.1.renames,
                                                                  integarted.atac.4.5M.2.renames,integarted.atac.RC.renames),project = "ATAC.prostate.combined") 
rm(integarted.atac.1M.1.renames,integarted.atac.1M.2.renames,integarted.atac.2.5M.1.renames,integarted.atac.2.5M.2.renames,integarted.atac.2.5M.3.renames,integarted.atac.2.5M.4.renames,integarted.atac.2W.1.renames,integarted.atac.2W.2.renames,integarted.atac.3.5M.1.renames,integarted.atac.3.5M.2.renames,integarted.atac.4.5M.1.renames,integarted.atac.4.5M.2.renames,integarted.atac.RC.renames,integarted.atac.WT.1.renames,integarted.atac.WT.2.renames)
gc()

save(atac.prostate.merge,file="atac.prostate.merge.Rdata")
