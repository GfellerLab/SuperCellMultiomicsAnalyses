...
```{r load_pbmcmc_g75}
pbmc.supercell.atac <- readRDS("../../output/pbmcMultiome/SuperCellATAC/g75/seurat.multiome.mc.activities.rds")
pbmc.supercell.atac <- addCellTypePBMC(pbmc.supercell.atac)

pbmc.seacells.atac <- readRDS("../../output/pbmcMultiome//seacellsATAC//g75/seurat.multiome.mc.activities.rds")
pbmc.seacells.atac <- addCellTypePBMC(pbmc.seacells.atac)

pbmc.seacells.rna <- readRDS("../../output/pbmcMultiome//seacellsRNA//g75/seurat.multiome.mc.activities.rds")
pbmc.seacells.rna <- addCellTypePBMC(pbmc.seacells.rna)

pbmc.supercell.rna <- readRDS("../../output/pbmcMultiome//SuperCellRNA//g75/seurat.multiome.mc.activities.rds")
pbmc.supercell.rna <- addCellTypePBMC(pbmc.supercell.rna)

pbmc.supercell.multi <- readRDS("../../output/pbmcMultiome//SuperCellMulti//g75/seurat.multiome.mc.activities.rds")
pbmc.supercell.multi <- addCellTypePBMC(pbmc.supercell.multi)

pbmc.metacell.rna <- readRDS("../../output/pbmcMultiome/MetaCellRNA//g75/seurat.multiome.mc.activities.rds")
  ...
  for (g in c(10,20,50,75,100)){
    for (i in methods){
      file <- paste0("../../output/pbmcMultiome/",
                     i,"/g",
                     g,
                     "/seurat.multiome.mc.activities.rds")
      if (file.exists(file)) {
...
input.colors.10Xmultiome <- c(colorblind_pal()(8)[2:4],"darkgrey")
...
nFeature_RNA <- ggplot(meta.sc.mc,aes(x=resolution,y=nFeature_RNA,fill = resolution)) + geom_violin(scale = "width")  + theme_bw() + theme(axis.title.x = element_blank(),axis.text.x = element_blank())  +
  scale_x_discrete(guide = guide_axis(angle = 60)) + 
  scale_fill_manual(values = colorblind_pal()(8)[c(3,7)]) 
...
nFeature_ATAC <- ggplot(meta.sc.mc,aes(x=resolution,y=nFeature_ATAC,fill = resolution)) + geom_violin(scale = "width") + theme_bw() + theme(axis.title.x = element_blank())  +
  scale_x_discrete(guide = guide_axis(angle = 60)) + scale_fill_manual(values = colorblind_pal()(8)[c(3,7)])  
...
```{r}
pbmc.supercell.multi.g20 <- readRDS("../../output/pbmcMultiome//SuperCellMulti//g20/seurat.multiome.mc.activities.rds")
...
nFeature_RNA <- ggplot(meta.sc.mc,aes(x=resolution,y=nFeature_RNA,fill = resolution)) + geom_violin(scale = "width") + theme_bw() + theme(axis.title.x = element_blank(),
                                                                                                                                          axis.text.x = element_blank())  +
  scale_x_discrete(guide = guide_axis(angle = 60)) + 
  scale_fill_manual(values = colorblind_pal()(8)[c(3,7)]) +  NoLegend()


nFeature_ATAC <- ggplot(meta.sc.mc,aes(x=resolution,y=nFeature_ATAC,fill = resolution)) + geom_violin(scale = "width") + theme_bw() + theme(axis.title.x = element_blank(),
                                                                                                                                            axis.text.x = element_blank())  +
  scale_x_discrete(guide = guide_axis(angle = 60)) + scale_fill_manual(values = colorblind_pal()(8)[c(3,7)]) + NoLegend()
